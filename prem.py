...
\x1b[0;97m╠═[\x1b[0;93m•\x1b[0;97m]\x1b[0;37m Facebook1 : Ahik Ahik                           ║
...
def menu():
    ...
    print((k+"["+p+"7"+k+"]"+p+" Check Opsi Akun CP"))
    print((k+"["+p+"8"+k+"]"+p+" Lihat Hasil Crack Saya"))
    print((k+"["+p+"9"+k+"]"+p+" Setting User Agent"))
    print((k+"["+p+"0"+k+"]"+p+" Keluar (Ahh Ngecrot)"))
    choose_menu()
